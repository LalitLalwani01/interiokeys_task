  ...
  return (
    <main className="bg-gray-100">
      <div className="container mx-auto py-6 px-4 lg:px-8">
        {/* Hero Section */}
        <div className="relative bg-cover bg-center h-64 rounded-md overflow-hidden shadow-md">
          <img
            src={HeroImage}
            alt="Hero Background"
          ...
          <div className="w-full lg:w-3/4 bg-white p-4 shadow-md rounded-md">
            ...
            <div className="h-[527px] mb-20">
              ...
              <h2 className="text-lg font-bold mb-4">
                &quot;Delighted to see so many interior inspirations for our
                properties&quot;
              </h2>
